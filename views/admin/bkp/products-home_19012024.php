    ...
    $.ajax({
        ...
        success:function(data){
            ...
            for(i=0;i<filesArray.length;i++){
                ...
                $('.images-preview').append('<div class="col-md-1 preview-div-'+i+'"><a href="javascript:void(0)" class="image-show"><i class="bi bi-x custom-icon" onclick="deleteImage('+i+')"></i><img src="../images/resized/'+filesArray[i]+'" alt=""></a></div>');
                }
            }
        }

                                ...
                                <div class="card" id="images-card">
                                    ...
                                    <?php
                                     ...
                                     for($i=0;$i<count($images);$i++){
                                        ?>
                                    <div class="col-md-1 preview-div-<?=$i?>"><a href="javascript:void(0)" class="image-show"><i class="bi bi-x custom-icon" onclick="deleteImage(<?=$i?>)"></i><img src="../images/resized/<?=$images[$i]?>" alt=""></a></div>
                                    <?php
                                         } 
                                      ?>
                                    </div>
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            for(i=0;i<filesArray.length;i++){
                var cleanedFileName = filesArray[i].replace(/\s+/g, '');
